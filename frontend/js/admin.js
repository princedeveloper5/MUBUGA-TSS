document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('[data-gallery-preview-open]').forEach((trigger) => {
        trigger.addEventListener('click', () => {
            ...
            previewEdit.href = `/MUBUGA-TSS/backend/admin/dashboard.php?edit=gallery&id=${encodeURIComponent(mediaId)}#gallery-panel`;
    ...
    if (galleryUploadForm && galleryUploadProgress && galleryUploadProgressBar && galleryUploadProgressLabel) {
        galleryUploadForm.addEventListener('submit', (event) => {
            ...
            request.addEventListener('load', () => {
                ...
                window.setTimeout(() => {
                    window.location.href = payload.redirect || '/MUBUGA-TSS/backend/admin/dashboard.php#gallery-panel';
                }, 500);
            });
