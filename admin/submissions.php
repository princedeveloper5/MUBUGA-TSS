        ...
        <aside class="admin-sidebar dashboard-sidebar submissions-sidebar">
            <div class="dashboard-sidebar-top">
                ...
                <nav class="dashboard-nav" aria-label="Submissions navigation">
                    <a href="/MUBUGA-TSS/admin/dashboard.php" class="dashboard-nav-link" data-tooltip="Dashboard" title="Dashboard" aria-label="Dashboard">
            ...
            <div class="dashboard-sidebar-footer">
                <a href="/MUBUGA-TSS/admin/dashboard.php" class="dashboard-nav-link" data-tooltip="Back to Dashboard" title="Back to Dashboard" aria-label="Back to Dashboard">
